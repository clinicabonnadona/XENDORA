                ...
                <div>
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="username" placeholder="Usuario" type="text" class="form-control @error('username') is-invalid @enderror login-form-input" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="password" placeholder="Contraseña" type="password" class="form-control @error('password') is-invalid @enderror login-form-input" name="password" required autocomplete="current-password">
