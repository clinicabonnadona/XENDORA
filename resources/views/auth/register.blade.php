                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <select name="doctype_id" id="doctype_id"
                                            class="form-control @error('doctype_id') is-invalid @enderror">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <input id="document" type="text" placeholder="Número de Documento"
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <input id="phone" type="text" placeholder="Número de Telefono"
